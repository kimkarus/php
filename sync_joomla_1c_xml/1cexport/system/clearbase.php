...
function clearBase($clear,$id = '1') 
{
	...
	if(VM_DB == 'yes' AND $clear == 'false' AND $id == '1') 
	{
		...
		$table_trun[] = $dba['currencies_to_1c_db'];
		...
		elseif (VM_VERVM == '2')
		{
			...
			$table_trun[] = $dba['customfields_db'];
			$table_trun[] = $dba['customfields_plg_db'];
			$table_trun[] = $dba['custom_param_plg_to_1c_db'];
			$table_trun[] = $dba['customs_to_1c_db'];
			$table_trun[] = $dba['customs_db'];
