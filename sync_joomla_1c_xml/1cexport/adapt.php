...
if (VM_VERVM == '2')
{
	...
	$dba['product_category_db'] = DBBASE."_product_categories";
	...
	$dba['product_files_db'] = DBBASE."_product_medias";
	...
	$dba['currencies'] = DBBASE."_currencies";
	...
	$dba['customfields_plg_db'] = DBBASE."_product_custom_plg_param_ref";
	$dba['customfields_plg_values_db'] = DBBASE."_product_custom_plg_param_values";
}
else
{
...
$dba['currencies_to_1c_db'] = DBBASE."_currencies_to_1c";
$dba['manufacturer_to_1c_db'] = DBBASE."_manufacturer_to_1c";
$dba['customs_to_1c_db'] = DBBASE."_customs_to_1c";
$dba['custom_param_plg_to_1c_db'] = DBBASE."_product_custom_param_plg_to_1c";
?>