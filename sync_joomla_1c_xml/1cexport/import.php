...
$filename = strval($_REQUEST['filename']);
$pos_import = stripos($filename, "import");
$pos_offers = stripos($filename, "offers");
...
if(defined( 'VM_SITE' ))
{
	...
	//if ($_REQUEST['filename'] == 'import.xml')
	{
		$form = 'vmshop_1c.php?mode=import&filename=offers0_1.xml';
