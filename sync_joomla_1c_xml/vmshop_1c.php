...
//***********************************************************************
//http://shop.nison.ru/vmshop_1c.php?mode=import&filename=import.xml
//Системные параметры
set_time_limit (0);
//Параметры отладки
...
define ( 'VM_EXT_FILES', $config['VM_EXT_FILES'] );		
...
//Параметры
define ( 'VM_LANG', $config['VM_LANG'] ); 		
// Язык 1С - требуется для характеристик (см adapt.php)
